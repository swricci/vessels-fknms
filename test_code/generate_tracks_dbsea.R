...
cargo_maerskmemphis<-fread("C:/Users/sbrown/Documents/dBSea_fknms/tracks_dbsea/cargo_maerskmemphis.csv")
cargo_maerskmemphis<-st_as_sf(cargo_maerskmemphis,coords=c('POINT_X','POINT_Y'), crs= "+init=epsg:32617")
...
cargo_maerskmemphis_track<-data.table(st_coordinates(cargo_maerskmemphis),cargo_maerskmemphis_time)
colnames(cargo_maerskmemphis_track)<-c("Easting","Northing", "Time")
write.csv(cargo_maerskmemphis_track,"C:/Users/sbrown/Documents/dBSea_fknms/tracks_dbsea/cargo_maerskmemphis_track.csv",row.names = F, quote = F)
