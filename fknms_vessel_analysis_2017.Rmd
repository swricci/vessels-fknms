...
SL_vessel_type_fig<-ggplot(vessel_type_SL)+
  ...
  geom_line(aes(x=fhz,y=q50.avg, group = class, color = class), size = 1) +##, linetype=class)) +
  ...
  scale_color_manual(values = c("Tanker" = "#1b9e77","Cargo" = "#d95f02","Fishing" = "#66a61e","Passenger" = "#7570b3", "Tug" = "#e6ab02","Pleasure craft" = "#e7298a"))

ggsave("SL_vesseltype_fig.eps",SL_vessel_type_fig)
ggsave("SL_vesseltype_fig.tiff",SL_vessel_type_fig, width = 6, height = 4, units = "in", dpi = 600)
```
