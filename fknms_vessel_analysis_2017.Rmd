...
tracks.bar<-ggplot(tracks2017.filt)+
  ...
  scale_fill_manual(name = "Vessel Class", values = c("Tanker" = "#1b9e77","Cargo" = "#d95f02","Fishing" = "#66a61e","Passenger" = "#7570b3", "Tug/Tow" = "#e6ab02","Recreational" = "#e7298a", "Other" = "#a6761d"))+
